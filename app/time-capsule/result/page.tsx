...
function topicMapper(topic: string) {
  switch (topic) {
    ...
    case "미래":
      return "우선 놀라지마!! 너가 그 당시에 바랬던 것들, 이루고자 했던 것들을 모두 이루었고 지금 나는 너가 원했던 모습으로 살아가고 있어. 힘들더라도 한 걸음씩 걸어 온 네가 있기에 지금의 내가 존재하는 거겠지? 지금 내가 해줄 수 있는 말은 너는 잘하고 있고, 조금씩 너가 원하는 모습에 가까워지고 있어!! 아 참! 요즘 내가 어떻게 지내는지 들려줄게";
    case "불안":
      return "내가 그 영상을 남겼을 때, 난 진짜 힘들었지...포기하고 싶은 순간들이 많았고.. 근데 말야, 지금의 나는 그때의 네가 너무나도 자랑스러워, 버텨줘서 고맙고 포기하지 않아서 다행이야! 지금의 내가 존재한다는 것은 너가 포기하지 않았다는 거겠지? 아 참! 요즘 내가 어떻게 지내는지 들려줄게";
    case "과거":
