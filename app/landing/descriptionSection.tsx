  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        <div
          className={`font-medium text-[16px]/[26px] transition-colors duration-700 ${
            textVisible[0] ? "text-gray-500" : "text-dark"
          }`}
        >
      ...
      >
        <div
          className={`font-medium text-[16px]/[26px] transition-colors duration-700 ${
            textVisible[1] ? "text-gray-500" : "text-dark"
          }`}
        >
      ...
      >
        <div
          className={`font-medium text-[16px]/[26px] transition-colors duration-700 ${
            textVisible[2] ? "text-gray-500" : "text-dark"
          }`}
        >
      ...
      <div
        ...
        className={`text-head2 mb-[32px] transition-colors duration-700 ${
          textVisible[3] ? "text-main-lilac50" : "text-dark"
        }`}
      >
        지금 시작하세요
      </div>
