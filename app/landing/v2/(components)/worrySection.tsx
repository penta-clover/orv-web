    ...
    <div className="flex flex-col items-center w-full">
      ...
      <div className="flex flex-col items-center text-body4 text-grayscale-200 w-full max-w-[384px] gap-[22px] px-[16px]">
        <div className="flex flex-row w-full">
          <span className={`bg-grayscale-700 rounded-[8px] p-[12px] ${scrolling ? "animate-shake-1" : ""}`}>
            요즘 나를 가장 힘들게 하는 것은?
          </span>
          <span className="grow" />
        </div>
        <div className="flex flex-row w-full">
          <span className="grow" />
          <span className={`bg-grayscale-800 rounded-[8px] p-[12px] ${scrolling ? "animate-shake-0.7" : ""}`}>
            최근 행복하다고 느꼈던 상황은 언제였나요?
          </span>
        </div>
        <div className="flex flex-row w-full">
          <span className={`bg-grayscale-700 rounded-[8px] p-[12px] ${scrolling ? "animate-shake-1.2" : ""}`}>
        ...
        <div className="flex flex-row w-full">
          <span className="grow" />
          <span className={`bg-grayscale-800 rounded-[8px] p-[12px] ${scrolling ? "animate-shake-0.9" : ""}`}>
