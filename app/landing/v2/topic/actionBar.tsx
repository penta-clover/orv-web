...
export default function ActionBar(props: { title?: string, onClickMenu: () => void }) {
  return (
    <div className="flex flex-row items-center justify-between h-[56px]">
      ...
      <div className="flex items-center justify-center grow text-head4 text-grayscale-white">{props.title}</div>
